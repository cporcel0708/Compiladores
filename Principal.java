 ...
 * */        
        ...
        if ( tabla.insertar(simbolo) == null ){
           System.out.println("Variable declarada: "+simbolo.getNombre()+" (Línea "+simbolo.getNroLinea()+").\n"); }
        if ( tabla.insertar(simbolo2) == null ){
           System.out.println("Variable declarada: "+simbolo2.getNombre()+" (Línea "+simbolo2.getNroLinea()+").\n");}
        

        Simbolo s = tabla.buscar("z");
        if (s==null) {
           System.out.println("Variable no declarada: z.\n");
        }
        else{
        ...
        s = tabla.buscar("x");
        if (s==null) {
           System.out.println("Variable no declarada: x.\n");
        }else{
           System.out.println("Simbolo:  "+s);
        }
